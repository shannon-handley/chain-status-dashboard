...
channels_data = [
    ...
    {"portfolio": "Pan Pacific", "project": "Pan Pacific", "channel": "Tiket", "status": "LIVE", "go_live_date": "2026-05-20", "notes": "Activated with switch partner (20 May); OTA Test booking confirmed, handed over to support"},
    ...
    {"portfolio": "Pan Pacific", "project": "Pan Pacific", "channel": "Hong Kong Convergent", "status": "LIVE", "go_live_date": "2026-05-21", "notes": "Activated with switch partner (21 May); OTA Test booking confirmed, handed over to support"},
    ...
    {"portfolio": "Pan Pacific", "project": "Pan Pacific", "channel": "Keytel", "status": "LIVE", "go_live_date": "2026-04-20", "notes": "Activated with switch partner (20 Apr); OTA Test booking confirmed, handed over to support"},
    ...
    {"portfolio": "Pan Pacific", "project": "Pan Pacific", "channel": "Traveloka", "status": "LIVE", "go_live_date": "2026-03-13", "notes": "Activated with switch partner (13 Mar - PRLGK, 2 Apr - remaining hotels); OTA Test booking confirmed, handed over to support"},
    ...
    {"portfolio": "Pan Pacific", "project": "Pan Pacific", "channel": "MG Bedbank", "status": "LIVE", "go_live_date": "2026-05-26", "notes": "Activated with switch partner (26MAY-PRYGN, 29MAY-5hotels, 05JUN-5hotels); OTA test booking confirmed; PPSSIN pending switch from OTA, then mapping from PPHG"},
    ...
    {"portfolio": "Pan Pacific", "project": "Pan Pacific", "channel": "Nuitee", "status": "IN PROGRESS", "go_live_date": "", "notes": "Ongoing testing/validations with Nuitee; pending update from OTA"},
...
issues_data = [
    ...
    },
    {
        "portfolio": "Pan Pacific",
        "project": "Agoda",
        "title": "Agoda rejects rates with error 1511 due to rate values sent by Distribution exceeding the allowed decimal places.",
        "issue_type": "Operational issue",
        "severity": "Medium",
        "owner": "OGTS",
        "impact": "Workaround in place. Rates are sent on whole numbers for the affected properties.",
        "escalation_status": "Escalated",
        "next_action": "Continue on workaround until decimal places can be sent correctly.",
        "link_type": "Slack",
        "link": "https://gbu-core.slack.com/archives/C07L44B259S/p1780651757049009",
        "summary": "Agoda rejects rates with error 1511 due to rate values sent by Distribution exceeding the allowed decimal places.",
    },
    {
        "portfolio": "Pan Pacific",
        "project": "Channel Publication",
        "title": "Error on channel publication on hub level",
        "issue_type": "Operational issue",
        "severity": "Medium",
        "owner": "OGTS",
        "created_at": "2026-06-03",
        "impact": "Workaround: channel publication on property level.",
        "escalation_status": "Watch",
        "next_action": "Continue on workaround until issue is fixed.",
        "link_type": "SR 260603-002118",
        "link": "",
        "summary": "Error on channel publication on hub level.",
    },
    {
        "portfolio": "Loews",
        "project": "Booking.com",
        ...
        "issue_type": "Operational issue",
        "severity": "High",
        "owner": "Product Team / Dev",
        "impact": "Excessive notes are appearing on Arrivals Report for Hotels.",
        "escalation_status": "Escalated",
        "next_action": "Call scheduled with Product Team and Dev for potential resolution.",
        "link_type": "Slack",
    ...
    },
    {
        ...
        "title": "OTA reservations are appearing in commission batches prior to processing in Opera Cloud",
        "issue_type": "Operational issue",
        "severity": "High",
        "owner": "Loews / Kurtis",
        "impact": "Loews is testing a bot for commission processing; testing an Expedia IATA change from alpha to numeric so the bot can read it.",
        "escalation_status": "Watch",
        "next_action": "Try to test changing IATA in UAT first to test reservation delivery.",
        "link_type": "Slack",
    ...
    },
    {
        ...
        "title": "Enable incl dep/cxl flags on transaction codes in prod",
        "issue_type": "Operational issue",
        "severity": "Medium",
        "owner": "Dev",
        "impact": "Chasing again with Dev. Loews has not reported this; this was raised internally.",
        "escalation_status": "Watch",
        "next_action": "Awaiting response from Dev.",
        "link_type": "Slack",
    ...
    },
    {
        ...
        "severity": "Medium",
        "owner": "Loews",
        "impact": "Hotel is seeing 9999 for the 365th date on OTAs because IDEAS does not send that day.",
        "escalation_status": "Watch",
        "next_action": "Awaiting Loews to confirm if they can get IDEAS to send the 365th day.",
        "link_type": "Email",
        "link": "",
    ...
    },
    {
        ...
        "severity": "Medium",
        "owner": "Concur",
        "impact": "Issue resides with Concur on incorrect data showing.",
        "escalation_status": "Watch",
        "next_action": "",
        "link_type": "Email",
        "link": "",
    ...
    },
    {
        ...
        "severity": "High",
        "owner": "Dev",
        "impact": "Issues with reservation data causes old SynXis bookings to duplicate when modified.",
        "escalation_status": "Watch",
        "next_action": "Received data from Booking.com and it is with Dev. Awaiting to see if it can be used for a solution.",
        "link_type": "Email",
        "link": "",
    ...
    },
    {
        ...
        "issue_type": "Operational issue",
        "severity": "Medium",
        "owner": "Loews/Agoda/Oracle",
        "impact": "Issue with how they want the Extra Adult field to populate.",
        "escalation_status": "Not Escalated",
        "next_action": "Awaiting clarification from Amanda and Agoda.",
        "link_type": "Email",
        "link": "",
...
ISSUE_ENRICHMENT = {
    ("Great Wolf", "Groupon"): {
        ...
        "next_action": "Confirm root cause and publish stabilization plan. Prod/Dev are looking into implementing retrigger function, no timeline defined yet.",
        "escalation_status": "Escalated",
        "blocked": True,
        "escalated": True,
    },
    ("Great Wolf", "Expedia"): {
        ...
        "next_action": "Product Team to confirm calculation decision and resume migration path. Dev is deploying permanent fix into Prod on 11 June 2026 at 6 AM EST. Oracle/GW/Expedia to repush ARI and validate the solution.",
        "escalation_status": "Watch",
        "blocked": True,
        "escalated": False,
    },
...
def normalize_source_records(
    ...
    if not non_live.empty:
        for (customer, status), group in non_live.groupby(["portfolio", "status"]):
            ...
            if customer == "Great Wolf" and status == "NEW":
                next_action = (
                    "Confirm owner progress and next milestone for grouped channels. "
                    "Follow-up sent to GW to define timeline, waiting for the response."
                )
            records.append(
                make_record(
